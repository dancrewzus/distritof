...
export class CloudAdapter {
   ...
   * image to a folder named in a format that includes a prefix followed by the type, e.g., 'pago-seguro-clients'.
   ...
   */
  public deleteAllResources = async (publicIds: string[]): Promise<void> => {
    try {
      this.initInstance()
